...
export const E_NUM_SIGNERS_MUST_EQ_NUM_MESSAGES : U64 = u64("3");
...
export function public_key_with_pop_to_normal_ (
  pkpop: PublicKeyWithPoP,
  $c: AptosDataCache,
): PublicKey {
  return new PublicKey({ bytes: $.copy(pkpop.bytes) }, new SimpleStructTag(PublicKey));
}
