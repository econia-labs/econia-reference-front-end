...
export class TestUSDCoin 
{
  ...
  static structName: string = "TestUSDCoin";
  ...
  static TestUSDCoinParser(data:any, typeTag: TypeTag, repo: AptosParserRepo) : TestUSDCoin {
...
export function loadParsers(repo: AptosParserRepo) {
  repo.addParser("0x7c36a610d1cde8853a692c057e7bd2479ba9d5eeaeceafa24f125c23d2abf942::test_usdc::TestUSDCoin", TestUSDCoin.TestUSDCoinParser);
}
export class App {
  constructor(
  ...
  get TestUSDCoin() { return TestUSDCoin; }
}
