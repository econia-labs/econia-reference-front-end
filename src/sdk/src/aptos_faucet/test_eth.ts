...
export class TestETHCoin 
{
  ...
  static structName: string = "TestETHCoin";
  ...
  static TestETHCoinParser(data:any, typeTag: TypeTag, repo: AptosParserRepo) : TestETHCoin {
...
export function loadParsers(repo: AptosParserRepo) {
  repo.addParser("0x7c36a610d1cde8853a692c057e7bd2479ba9d5eeaeceafa24f125c23d2abf942::test_eth::TestETHCoin", TestETHCoin.TestETHCoinParser);
}
export class App {
  constructor(
  ...
  get TestETHCoin() { return TestETHCoin; }
}
