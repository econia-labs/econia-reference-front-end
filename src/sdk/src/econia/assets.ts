...
export const UTILITY_COIN_NAME : U8[] = [u8("85"), u8("116"), u8("105"), u8("108"), u8("105"), u8("116"), u8("121"), u8("32"), u8("99"), u8("111"), u8("105"), u8("110")];
...
export function init_module_ (
  ...
  init_coin_type_(account, $.copy(UTILITY_COIN_NAME), $.copy(UTILITY_COIN_SYMBOL), $.copy(UTILITY_COIN_DECIMALS), $c, [new SimpleStructTag(UC)]);
  return;
}
